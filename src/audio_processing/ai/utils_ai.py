...
def save_predictions_to_csv(all_data_subfolder, col_names, subfolder_name, subfolder, model_type, logging, window_size=None, stable_version=None):
    ...
    if window_size is not None:
        ...
        if model_type == "port": output_filename = f'Port_Model_{subfolder_name}_w_{window_size}s_{stable_version}.csv'            
        else: output_filename = f'Urban_Model_{subfolder_name}_w_{window_size}s_{stable_version}.csv'
            
    else:

        if model_type == "port": output_filename = f'Port_Model_{subfolder_name}_{stable_version}.csv'            
        else: output_filename = f'Urban_Model_{subfolder_name}_{stable_version}.csv'
